...
public class PageOrders extends JPanel {
//    static int index;
...
//        btnxoa_donhang.setEnabled(true);  //DangNhap.action_xoa
...
//                soluong = Arrays.stream(soluong)
//                        .map(value -> new Integer((String) table_DH.getValueAt(value, 1)))
//                        .toArray();
//
//                orderDetailsService.deleteOrderDetails(soluong);
//                orderService.deleteOrders(soluong);
//                orderService.findAll(table_DH);
//            }
//        });
...
////        btnnhapfile.addActionListener(e -> JOptionPane.showMessageDialog(null, "tính năng đang phát triển"));
...
//                String value = textField_thanhtimkiem.getText().trim();
...
//                    else orderService.findByCondition(table_DH, value, condition);
//                }
//            }
//        });
...
//        comboBox.setModel(new DefaultComboBoxModel(new String[]{"Ma hoa don", "Ngay tao", "Tong tien", "Ma nhan vien"}));
...
//            OrderDetails chitiet = new OrderDetails(table_DH.getValueAt(row, 1));
//            tabbedPane.add(chitiet, "Đơn hàng " + (index), index);
//            tabbedPane.setTabComponentAt(index, new customJTabbedpane(this));
//            tabbedPane.setSelectedIndex(index);
//            index++;
//        } catch (Exception e1) {
//            JOptionPane.showMessageDialog(null, e1.getMessage(), "Hiển thị thông tin đơn hàng thất bại", JOptionPane.ERROR_MESSAGE);
//        }
//    }
//
...
//
//        private PageOrders customTabbed;
//
//        public customJTabbedpane(PageOrders tabbed) {
